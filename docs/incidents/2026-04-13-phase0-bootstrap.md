...
Postmortems for issues encountered during the first real compile runs.
Each entry preserves the *why* behind a fix — useful when the next person
(or LLM) wonders "why is the code shaped like this?"
