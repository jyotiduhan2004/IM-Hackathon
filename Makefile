...
audit-nightly: ## Sample last 20 Langfuse traces + grade → docs/audits/nightly-*.json
...
lint-wiki-fix: ## Run wiki health checks and auto-normalize wikilinks (stubs are NOT auto-created; call create_entities() from a reader)
